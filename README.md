...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyquicksetup-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12600&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyquicksetup-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyquicksetup` can be installed with:

```
conda install pyquicksetup
```

It is possible to list all of the versions of `pyquicksetup` available on your platform with:
